...
(`quarantined` extends the accepted model per ADR-0123, currently `proposed`; `validated` and
`rolled-back` are advanced-tier states — conventions, nothing enforces them.)
