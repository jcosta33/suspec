...
Memory is not a landfill. Use documented native harness memory only for durable personal lessons.
Suspec owns no memory directory, format, retrieval engine, or loading guarantee.
...
Without native memory, let personal scratch die. Route team lessons through issues, decisions,
