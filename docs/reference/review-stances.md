...
3. After each stance, the orchestrator verifies every finding and fixes, rejects, or names the
   concrete blocker and stops. Reviewers never edit.
...
trust-relevant rejected findings, and concrete blockers.
