...
| **oversized-packet check**    | A toolable advisory (named, not yet shipped) flagging a task or review packet whose changed-LOC + files-touched exceed a heuristic band; the size anchor is a vendor heuristic, not law (ADR-0094).                          |
