...
| **Ambiguous input**         | ambiguity measurably degrades generated code, and models do not reliably flag or resolve it on their own [[ORCHID]](research/sources.md#ORCHID)                                                                                        | requirements written one per ID, each with its own verification method                                                                                                                 |
| **Lost handoff**            | the handoff from plan to implementation is the dominant failure surface in multi-step agent work [[PLANCODER]](research/sources.md#PLANCODER)                                                                                          | the handoff is a written, bounded task packet — not a chat message                                                                                                                     |
| **Hallucinated completion** | "done," but nothing was checked — in a randomized trial, developers _believed_ they were ~20% faster with AI while _measuring_ ~19% slower [[METR]](research/sources.md#METR) (preliminary: 16 experienced developers on mature repos) | a Pass needs pasted output or a CI link; an empty Evidence cell means Unverified, never Pass (a review checklist rule)                                                                 |
