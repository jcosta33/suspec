...
- Status: active
- Type: research
- Deliverable path: `<your-research-dir>/{{slug}}.md`
...
> Copy everything between this line and the `--- END DELIVERABLE ---` marker into `<your-research-dir>/{{slug}}.md` at session close, demoting headings as needed.
>
...
Active / Superseded by `<your-research-dir>/<newer-slug>.md`
