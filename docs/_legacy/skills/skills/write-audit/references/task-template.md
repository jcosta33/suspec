...
- Status: active
- Type: audit
- Deliverable path: `<your-audits-dir>/{{slug}}.md`
...
- **Proactively research and read related docs** under `<your-audits-dir>/`, `<your-specs-dir>/`, `<your-research-dir>/`, `docs/`, `AGENTS.md`, and the project skills directory.
...
> Copy everything between this line and the `--- END DELIVERABLE ---` marker into `<your-audits-dir>/{{slug}}.md` at session close, demoting headings as needed.
>
...
- Prior audit (if deepening): `<your-audits-dir>/<prior-slug>.md`
- Related specs: `<your-specs-dir>/<slug>.md`
