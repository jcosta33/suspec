...
- Status: active
- Type: spec-writing
- Deliverable path: `<your-specs-dir>/{{slug}}.md`
...
- **Proactively research and read related docs** under `<your-specs-dir>/`, `<your-audits-dir>/`, `<your-research-dir>/`, `<your-adrs-dir>/`, `docs/`, `AGENTS.md`, and source code (read-only).
...
> Copy everything between this line and `--- END DELIVERABLE ---` into `<your-specs-dir>/{{slug}}.md` at close, demoting headings as needed. ⚠️ **VERIFIABILITY OVER COMPLETENESS** — every requirement testable; rewrite or remove wishes.
