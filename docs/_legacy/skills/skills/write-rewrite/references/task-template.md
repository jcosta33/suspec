...
- **Proactively research and read related docs.** Browse `<your-specs-dir>/`, `<your-research-dir>/`, `<your-bugs-dir>/`, `docs/`, `AGENTS.md`, and the project skills directory as needed.
