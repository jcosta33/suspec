...
- **Proactively research and read related docs.** Browse `<your-bugs-dir>/`, `<your-specs-dir>/`, `<your-audits-dir>/`, `docs/`, `AGENTS.md`, and the project skills directory as needed.
