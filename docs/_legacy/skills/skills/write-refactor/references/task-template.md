...
- **Proactively research and read related docs.** Browse `<your-audits-dir>/`, `<your-specs-dir>/`, `<your-research-dir>/`, `docs/`, `AGENTS.md`, and the project skills directory as needed.
