...
- Status: active
- Type: bug-report
- Deliverable path: `<your-bugs-dir>/{{slug}}.md`
...
- **Proactively research and read related docs** under `<your-audits-dir>/`, `<your-specs-dir>/`, `<your-research-dir>/`, `<your-bugs-dir>/`, and `docs/`.
...
> Copy everything between this line and `--- END DELIVERABLE ---` into `<your-bugs-dir>/{{slug}}.md` at close, demoting headings as needed. ⚠️ **REPRODUCE BEFORE YOU EXPLAIN** — a bug is a hypothesis until reproduced; the symptom is a clue, not a description. If you cannot reproduce, say so.
