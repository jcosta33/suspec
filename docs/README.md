...
3. [Where files live](03-where-files-live.md) - your repo, the store, the lifecycle.
...
7. [Running agents](07-running-agents.md) - worktrees, runs, evidence.
8. [Reviewing output](08-reviewing-output.md) - reconciliation, exceptions, the gate.
9. [Saving findings](09-saving-findings.md) - triage, promotion, retrieval.
...
- [Adopting Suspec](ADOPTING.md) - set up in a repo.
