...
- [`improve`](../passes/improve.md) — a pass that ships no guide; a project convention composes additively with its pass contract, adding project expectations without changing the procedure.
