...
- The **project layer** (`AGENTS.md > Commands`) names the concrete command for *this* repo. The `cmd*` placeholder rows **are** the adapters; only this table changes when a `spec.swarm.md` moves between repos.
