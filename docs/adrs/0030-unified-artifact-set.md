...
- One verdict location (`review.md`) and one obligation source (`spec.swarm.md`) remove the ambiguity of a free-standing verdict file or competing source names.
