...
(the Swarm family: canon / starter-kit / skills / cli / website; the general case: features
...
condition). The Swarm family's own multi-repo workspace is a separate owner action.
