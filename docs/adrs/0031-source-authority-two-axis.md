...
Authority is resolved on **two orthogonal axes, applied lexicographically — domain first, then artifact** — as detailed in the source-authority reference (``docs/model/source-authority.md``).
