...
- The `spec.swarm.md` obligations in scope — every `REQ`, `CONSTRAINT`, `INVARIANT`, `INTERFACE` with its required `VERIFY BY` bindings (the `review` step).
