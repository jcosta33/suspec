...
`review-output` guide and `starter-kit/templates/review.md`; review results are Pass · Fail ·
Unverified · Blocked. All of it is checklist level: nothing in this repo enforces it.
