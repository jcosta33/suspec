...
| C004 `one-strength-word`  | every AC                           | exactly one strength word each → clean                                                                                                                                           | hard error              |
| C028 `requirement-shape`  | every AC                           | one `When`, `Then`, and `Verify with` item in order → clean                                                                                                                       | hard error              |
